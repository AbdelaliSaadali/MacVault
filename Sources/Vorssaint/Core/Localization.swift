...
extension Strings {
    static let enUS = Strings(
        ...
        menuAbout: "About MacVault",
        menuQuit: "Quit MacVault",
        ...
        settingsTitle: "MacVault Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
