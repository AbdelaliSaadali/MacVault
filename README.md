...
> **MacVault** is an independent, unofficial fork of [Vorssaint](https://github.com/vorssaintapp/vorssaint-utils), adapted for Intel Macs and extended with additional fixes and custom branding. It is not affiliated with or endorsed by the original Vorssaint project.
